...
public class SpringXmlBasedApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(new String("ApplicationContextXml.xml"));
		...
		PizzaOrderService orderService = context.getBean("pizzaOrderService", PizzaOrderServiceImpl.class);
